  ...
  useEffect(() => {
    async function readData() {
      ...
      querySnapshot.forEach(async (doc) => {
        ...
        temp.push({docId: doc.id, content: doc.data().content, title: doc.data().title, user: doc.data().user, count: doc.data().count, heart: doc.data().heart, timestamp: doc.data().timestamp}); 
      });
